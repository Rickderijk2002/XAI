...
![HomeScreen 1](images/Final prototype/Home Screen Final Version.png){#fig-homescreen-1}

![Homescreen 2](images/Final prototype/HomeScreen Final Version2.png){#fig-homescreen-2}

![Visual Inspection FV](images/Final prototype/Visual Inspection Final Version.png){#fig-visual-inspec-fv}

![User Prediction FV](images/Final prototype/Your Prediction FV.png){#fig-user-pred-fv}

![The Game](images/Final prototype/The Game FV2.png){#fig-game-fv}

![Actual metrics 1](images/Final prototype/Actual Metrics FV.png){#fig-actual-1}

![Actual metric 2](images/Final prototype/Actual Metrics 2.png){#fig-actual-2}

![Actual metric 3](images/Final prototype/Actual Metrics FV 3.png){#fig-actual metric 3}

![Explanation & Feedback FV 1](images/Final prototype/Explanation & Feedback 1.png)

![Explanation & Feedback 2](images/Final prototype/Explanation & feedback 2.png){#fig-expla-2}

![Compare methods FV 1](images/Final prototype/Compare all methods 1.png)

![Compare methods 2 FV](images/Final prototype/Compare all methods 2.png)

![Compare methods FV 3](images/Final prototype/Compare all methods 3.png)

![Final Thought & Confidence FV 1](images/Confidence & Final Thoughts.png)

![Final Thought & Confidence 2](images/Final prototype/Confidence  & final thoughts 2.png)

![Confidence 3](images/confidence 3.png)

# Appendix Archive Prototype {#sec-appendix-archive-prototype}

![Homescreen](images/Filling_in_name.png){#fig-home width="1694"}

![Visual Inspection](images/Visual-Inspection.png){#fig-visual}

![User Prediction](images/Your prediciton (3).png){#fig-prediction-users}

![The Game](images/Game choose the best explanation(4).png){#fig-game}

![Actual Metrics](images/Actual Metrics (5).png){#fig-metrics}

![Explanation & Feedback](images/Explanation & Feedback (6).png)

![Compare methods 1.1](images/Compare methods on this case (7.1).png){#fig-compare-methods1}

![Compare methods 1.2](images/Compare methods on this case (7.2).png){#fig-compare-methods2}

![Final Though & Confidence](images/Confidence & Final Thoughts (8).png){#fig-conclusion}
