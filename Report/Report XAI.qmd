...
What you wanted to learn from testing (can align with protocol objective + your global RQ; one tight paragraph).

## Method

Repeatable study: participant profile (e.g. data science students, N = 5), date/window, setting, facilitator roles, consent/recording, exact task (“complete one full guided run”), think-aloud instruction, post-test questions (list Q1–Q4 from the PDF). Say how you recorded data (notes, transcripts, optional video).
