...
## Divergence: Generating Design Concepts
...
## COCD Box: Structuring Divergence and Convergence
...
## Convergence: Selection of Design Direction
...
component already present in Step 3 (see @fig-game-fv in the appendix).
...
of validity through practice rather than instruction (see @fig-minigame-homescreen and @fig-leaderboard in the
appendix).
...
![Mini-Game Homescreen](images/Final%20prototype/Mini%20Game%20homescreen.png){#fig-minigame-homescreen}
...
![Leaderboard](images/Final%20prototype/Leaderbord.png){#fig-leaderboard}
